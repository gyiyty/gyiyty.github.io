...
- 示例2
	- ![](img/Pasted image 20251127000713.png)
	- 过程类似示例1
- 示例3
	- ![](img/Pasted image 20251127000741.png)
	- $S_3$在接受[A 3.1 X]前就已经收到[P 4.5]，因此并未通过该`Proposal`(详见**两个承诺**)
- 示例4(活锁)
	- ![](img/Pasted image 20251127001048.png)
