...
- `Learner`
	- 学习决议结果
## 伪代码
![600](/notes-assets/pasted-image-20251126233233.png)
## 示例
- **注意**：$S_1$和$S_5$是`proposer`，其他是`Acceptor`
- P代表`Prepare`阶段，A代表`Accept`阶段
- 3.1和4.5是`Proposal ID`(3.1 ：3为时间戳，1为Server ID) 
- 示例1
	- ![Pasted_image_20251126234234](/notes-assets/pasted-image-20251126234234.png)
...
- 示例2
	- ![Pasted_image_20251127000713](/notes-assets/pasted-image-20251127000713.png)
	- 过程类似示例1
- 示例3
	- ![Pasted_image_20251127000741](/notes-assets/pasted-image-20251127000741.png)
	- $S_3$在接受[A 3.1 X]前就已经收到[P 4.5]，因此并未通过该`Proposal`(详见**两个承诺**)
- 示例4(活锁)
	- ![Pasted_image_20251127001048](/notes-assets/pasted-image-20251127001048.png)
